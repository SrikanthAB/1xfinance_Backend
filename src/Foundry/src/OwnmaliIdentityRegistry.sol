...
contract MockIdentityRegistry {
    ...
    function issuersRegistry() external pure returns (address) {
        return address(0);
    }
    
    function topicsRegistry() external pure returns (address) {
        return address(0);
    }
    
    function identityStorage() external pure returns (address) {
        return address(0);
    }
    
    function investorCountry(address _wallet) external pure returns (uint16) {
        return 0;
    }
    ...
    function identity(address _userAddress) external pure returns (address) {
        return address(0);
    }
