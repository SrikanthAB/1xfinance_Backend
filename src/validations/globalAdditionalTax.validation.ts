...
const GlobalAdditionalTaxValidationSchema = z.object({
...
const CreateGlobalAdditionalTaxValidation = GlobalAdditionalTaxValidationSchema;
const UpdateGlobalAdditionalTaxValidation = GlobalAdditionalTaxValidationSchema.partial().refine(
  (data) => Object.keys(data).length > 0,
  { message: 'At least one field must be provided for update', path: [] }
);

export { CreateGlobalAdditionalTaxValidation, UpdateGlobalAdditionalTaxValidation }; 